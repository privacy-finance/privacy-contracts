...
interface IMasterChef {
    ...
    function pendingPriv(uint256 _pid, address _user) external view returns (uint256);
...
// File: contracts/PrivVault.sol

pragma solidity 0.6.12;

contract PrivVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingPriv(0, address(this));
